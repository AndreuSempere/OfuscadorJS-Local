...
function getRandomDecoyString(length) {
  var result = "";
...
var _default = exports["default"] = function _default(_ref) {
  ...
  var stringsName = me.getPlaceholder() + "_array";
  var stringsValue = "";
    ...
    visitor: {
      Program: {
        exit: function exit(programPath) {
          ...
          stringsValue += getRandomDecoyString((0, _randomUtils.getRandomInteger)(100, 250));
          programPath.traverse({
            StringLiteral: {
              exit: function exit(path) {
                ...
                var stringEntry = stringMap.get(encodedValue);
                if (typeof stringEntry === "undefined") {
                  // Leading decoy
                  stringsValue += getRandomDecoyString((0, _randomUtils.getRandomInteger)(0, 5));
                ...
                path.replaceWith(t.callExpression(t.identifier(stringConcealingInterface.fnName), [(0, _node.numericLiteral)(stringEntry.start), (0, _node.numericLiteral)(stringEntry.length)]));
          ...
          stringsValue += (0, _randomUtils.getRandomString)((0, _randomUtils.getRandomInteger)(100, 250));
          ...
          (0, _astUtils.prependProgram)(programPath, new _template["default"]("var {stringsName} = {stringsValue};").single({
          ...
          for (var _i = 0, _blocks = blocks; _i < _blocks.length; _i++) {
            ...
            var retrieveFunctionDeclaration = new _template["default"]("\n              function ".concat(fnName, "(start, length) {\n                return ").concat(decodeFnName, "(").concat(stringsName, "[\"slice\"](start, start+length));\n              }\n            ")).addSymbols(_constants.NO_REMOVE).single();
